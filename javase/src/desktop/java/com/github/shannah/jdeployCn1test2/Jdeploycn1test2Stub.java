...
package com.github.shannah.jdeployCn1test2;
 ...
 * @author Shai Almog
 */
public class Jdeploycn1test2Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Jdeploy Cn1test 2";
    private static final String APP_NAME = "jdeploy-cn1test-2";
    ...
    private Jdeploycn1test2 mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Jdeploycn1test2Stub());
    }
